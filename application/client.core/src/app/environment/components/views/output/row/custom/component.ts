...
@Component({
    selector: 'app-views-output-row-custom',
    templateUrl: './template.html',
    styleUrls: ['./styles.less'],
    // encapsulation: ViewEncapsulation.None
})

export class ViewOutputRowCustomComponent extends AOutputRenderComponent implements AfterContentInit, AfterContentChecked, OnDestroy {
    ...
    private _getHTML(str: string): string {
        ...
        // Apply common parser
        str = OutputParsersService.row(str);
