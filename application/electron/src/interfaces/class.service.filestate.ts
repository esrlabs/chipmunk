...
/**
 * @class ClassServiceFileState
 * @description Used as parent for state services
 */

export class ClassServiceFileState<TState> implements IService {
    ...
    constructor(alise: string, defaults: TState, file: string) {
        this._logger = new Logger(alise);
        this._defaults = defaults;
        this._file = ServicePaths.resoveHomeFolder(file);
        console.log(`Settings: ${this._file}`);
