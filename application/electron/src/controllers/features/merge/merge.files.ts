...
import { Lvin, IIndexResult, IFileToBeMerged, IFileMapItem, ILogMessage } from '../../external/controller.lvin';
    ...
    public write(): Promise<number> {
        return new Promise((resolve, reject) => {
            ...
            this._getSize().then((size: number) => {
                ...
                // Start session
                ServiceStreams.addProgressSession(this._writeSessionsId, 'merging', this._session);
