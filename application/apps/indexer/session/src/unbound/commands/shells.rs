...
pub fn get_valid_profiles(_signal: Signal) -> Result<CommandOutcome, ComputationError> {
    let mut profiles =
...
pub fn get_context_envvars(_signal: Signal) -> Result<CommandOutcome, ComputationError> {
    let envvars =
