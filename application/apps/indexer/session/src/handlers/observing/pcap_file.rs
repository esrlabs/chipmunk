...
use sources::{factory::ParserType, pcap::file::PcapngByteSource};
...
pub async fn observe_pcap_file<'a>(
    ...
    match parser {
        ParserType::Text => Err(NativeError {
            ...
            message: Some(String::from("Text parser cannot be used with pcap source")),
        }),
        ParserType::Dlt(_) => {
