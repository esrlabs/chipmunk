...
impl CommonDescriptor for PluginDescriptor {
    ...
    fn fields_getter(&self, _origin: &stypes::SessionAction) -> descriptor::FieldsResult {
...
impl ParserDescriptor for PluginDescriptor {
