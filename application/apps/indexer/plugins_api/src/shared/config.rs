...
/// Macro to generate getter functions for each [`ConfigValue`] type.
macro_rules! generate_get_config_function {
...
generate_get_config_function!(get_as_boolean, bool, ConfigValue::Boolean);
generate_get_config_function!(get_as_integer, i32, ConfigValue::Integer);
generate_get_config_function!(get_as_float, f32, ConfigValue::Float);
generate_get_config_function!(get_as_text, str, ConfigValue::Text);
generate_get_config_function!(get_as_directories, [String], ConfigValue::Directories);
generate_get_config_function!(get_as_files, [String], ConfigValue::Files);
generate_get_config_function!(get_as_dropdown, str, ConfigValue::Dropdown);
