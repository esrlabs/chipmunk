...
export type ValueInput = { "Checkbox": boolean } | { "Number": number } | { "String": string } | { "Numbers": [Array<number>, number] } | { "Strings": [Array<string>, string] } | { "NamedBools": Array<[string, boolean]> } | { "NamedNumbers": Array<[string, number]> } | { "NamedStrings": Array<[string, string]> } | { "KeyNumber": Map<string, number> } | { "KeyNumbers": Map<string, number[]> } | { "KeyString": Map<string, string> } | { "KeyStrings": Map<string, string[]> } | { "NestedNumbersMap": [Map<string, Map<string, Map<string, number>>>, Map<string, string>] } | { "NestedStringsMap": [Map<string, Map<string, Map<string, string>>>, Map<string, string>] } | "Directories" | { "Files": Array<string> } | { "File": Array<string> } | "Directory" | { "Bound": { output: ValueInput, inputs: Array<ValueInput>, } };
