...
export namespace observe {
    ...
    export class DltParserSettings extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.with_storage_header != false) writer.writeBool(3, this.with_storage_header);
            if (this.tz.length) writer.writeString(4, this.tz);
            if (!w) return writer.getResultBuffer();
        }
    ...
    export class DltFilterConfig extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.min_log_level != 0) writer.writeUint32(1, this.min_log_level);
            ...
            if (this.app_id_count != 0) writer.writeInt64(5, this.app_id_count);
            if (this.context_id_count != 0) writer.writeInt64(6, this.context_id_count);
            if (!w) return writer.getResultBuffer();
        }
    ...
    export class ProcessTransportConfig extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.cwd.length) writer.writeString(1, this.cwd);
            if (this.command.length) writer.writeString(2, this.command);
    ...
    export class SerialTransportConfig extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.baud_rate != 0) writer.writeUint32(2, this.baud_rate);
            if (this.data_bits != 0) writer.writeUint32(3, this.data_bits);
            if (this.flow_control != 0) writer.writeUint32(4, this.flow_control);
            if (this.parity != 0) writer.writeUint32(5, this.parity);
            if (this.stop_bits != 0) writer.writeUint32(6, this.stop_bits);
            if (this.send_data_delay != 0) writer.writeUint32(7, this.send_data_delay);
            if (this.exclusive != false) writer.writeBool(8, this.exclusive);
            if (!w) return writer.getResultBuffer();
        }
    ...
    export class TCPTransportConfig extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.bind_addr.length) writer.writeString(1, this.bind_addr);
            if (!w) return writer.getResultBuffer();
        }
    ...
    export class MulticastInfo extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.multiaddr.length) writer.writeString(1, this.multiaddr);
            if (this.interface.length) writer.writeString(2, this.interface);
            if (!w) return writer.getResultBuffer();
        }
    ...
    export namespace ObserveOrigin {
        export class File extends pb_1.Message {
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                ...
                if (this.format != FileFormat.Type.PcapNG) writer.writeEnum(2, this.format);
