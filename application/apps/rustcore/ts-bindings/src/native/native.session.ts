...
export abstract class RustSessionNative {
    ...
    public abstract applySearchFilters(filters: Array<{ value: string, is_regex: boolean, ignore_case: boolean, is_word: boolean, }>): IGeneralError | string;
...
export class RustSessionDebug extends RustSession {
    ...
    public search(filters: IFilter[]): string | IGeneralError {
        return this._native.applySearchFilters(filters.map((filter) => {
            return {
                value: filter.filter,
