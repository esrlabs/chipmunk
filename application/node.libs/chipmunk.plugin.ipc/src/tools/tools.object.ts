export function isObject(smth: any): boolean {
    if (typeof smth !== 'object' || smth === null) {
        return false;
    } else if (smth instanceof Array) {
        return false;
    } else if (typeof smth.constructor === 'function' && typeof smth.constructor.name === 'string' && smth.constructor.name.toLowerCase() !== 'object') {
        return false;
    }
    return true;
}
