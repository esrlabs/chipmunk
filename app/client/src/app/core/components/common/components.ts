...
@NgModule({
    entryComponents : [ Popup, FileLoader, ProgressBarCircle, DialogADBLogcatStreamSettings, DialogUpdate, DialogThemesList, DialogSerialPortsList, ProgressBarLine, ProgressBarProgress, DialogMessage, DialogStatemonitorIndicateEdit, StateMonitorStateEditIconsDialog, StateMonitorStateEditDialog, ImageDialog, DialogA, ButtonFlatText, SimpleText, SimpleList, SimpleDropDownList, DialogSerialSettings, SimpleCheckbox, ViewsList, ShortcutsList, DialogAPISettings, ColorsDialog, ColorsCanvasDialog, ConnectionState, ChartEditTypeDialog, ChartEditRulesSegmentsDialog, ChartEditRulesHooksDialog, ChartEditColorDialog, MarkersEditDialog, DialogStatemonitorEditJSON ],
    imports         : [ CommonModule, FormsModule  ],
    declarations    : [ CommonInput, DropDownMenu, Popup, FileLoader, DialogADBLogcatStreamSettings, DialogUpdate, DialogThemesList, DialogSerialPortsList, ProgressBarCircle, ProgressBarLine, ProgressBarProgress, DialogMessage, DialogStatemonitorIndicateEdit, StateMonitorStateEditIconsDialog, StateMonitorStateEditDialog, ImageDialog, DialogA, ButtonFlatText, SimpleText, SimpleList, SimpleDropDownList, DialogSerialSettings, SimpleCheckbox, ViewsList, ShortcutsList, DialogAPISettings, ColorsDialog, ColorsCanvasDialog, ConnectionState, ChartEditTypeDialog, ChartEditRulesSegmentsDialog, ChartEditRulesHooksDialog, ChartEditColorDialog, MarkersEditDialog, DialogStatemonitorEditJSON ],
    exports         : [ CommonInput, DropDownMenu, LongListModule, CommonTabModule, Popup, FileLoader, DialogADBLogcatStreamSettings, DialogUpdate, DialogThemesList, DialogSerialPortsList, ProgressBarCircle, ProgressBarLine, ProgressBarProgress, DialogMessage, DialogStatemonitorIndicateEdit, StateMonitorStateEditIconsDialog, StateMonitorStateEditDialog, ImageDialog, DialogA, ButtonFlatText, SimpleText, SimpleList, SimpleDropDownList, DialogSerialSettings, SimpleCheckbox, ViewsList, ShortcutsList, DialogAPISettings, ColorsDialog, ColorsCanvasDialog, ConnectionState, ChartEditTypeDialog, ChartEditRulesSegmentsDialog, ChartEditRulesHooksDialog, ChartEditColorDialog, MarkersEditDialog, DialogStatemonitorEditJSON ]
})
