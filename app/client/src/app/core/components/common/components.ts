...
@NgModule({
    entryComponents : [ CommonSimpleTable, Popup, FileLoader, ProgressBarCircle, DialogMessageList, DialogSearchRequestsPresets, DialogTerminalStreamOpen, DialogADBLogcatStreamSettings, DialogUpdate, DialogThemesList, DialogSerialPortsList, ProgressBarLine, ProgressBarProgress, DialogMessage, DialogStatemonitorIndicateEdit, StateMonitorStateEditIconsDialog, StateMonitorStateEditDialog, ImageDialog, DialogA, ButtonFlatText, SimpleText, SimpleList, SimpleDropDownList, DialogTelnetSettings, DialogSerialSettings, SimpleRadioGroup, SimpleCheckbox, ViewsList, ShortcutsList, DialogAPISettings, ColorsDialog, ColorsPredefinedDialog, ColorsCanvasDialog, ProgressBarGlobal, ConnectionState, ChartEditTypeDialog, ChartEditRulesSegmentsDialog, ChartEditRulesHooksDialog, ChartEditColorDialog, MarkersEditDialog, DialogStatemonitorEditJSON ],
    imports         : [ CommonModule, FormsModule  ],
    declarations    : [ CommonInput, DropDownMenu, CommonSimpleTable, Popup, FileLoader, DialogMessageList, DialogSearchRequestsPresets, DialogTerminalStreamOpen, DialogADBLogcatStreamSettings, DialogUpdate, DialogThemesList, DialogSerialPortsList, ProgressBarCircle, ProgressBarLine, ProgressBarProgress, DialogMessage, DialogStatemonitorIndicateEdit, StateMonitorStateEditIconsDialog, StateMonitorStateEditDialog, ImageDialog, DialogA, ButtonFlatText, SimpleText, SimpleList, SimpleDropDownList, DialogTelnetSettings, DialogSerialSettings, SimpleRadioGroup, SimpleCheckbox, ViewsList, ShortcutsList, DialogAPISettings, ColorsDialog, ColorsPredefinedDialog, ColorsCanvasDialog, ProgressBarGlobal, ConnectionState, ChartEditTypeDialog, ChartEditRulesSegmentsDialog, ChartEditRulesHooksDialog, ChartEditColorDialog, MarkersEditDialog, DialogStatemonitorEditJSON ],
    exports         : [ CommonInput, DropDownMenu, LongListModule, CommonTabModule, CommonSimpleTable, Popup, FileLoader, DialogMessageList, DialogSearchRequestsPresets, DialogTerminalStreamOpen, DialogADBLogcatStreamSettings, DialogUpdate, DialogThemesList, DialogSerialPortsList, ProgressBarCircle, ProgressBarLine, ProgressBarProgress, DialogMessage, DialogStatemonitorIndicateEdit, StateMonitorStateEditIconsDialog, StateMonitorStateEditDialog, ImageDialog, DialogA, ButtonFlatText, SimpleText, SimpleList, SimpleDropDownList, DialogTelnetSettings, DialogSerialSettings, SimpleRadioGroup, SimpleCheckbox, ViewsList, ShortcutsList, DialogAPISettings, ColorsDialog, ColorsPredefinedDialog, ColorsCanvasDialog, ProgressBarGlobal, ConnectionState, ChartEditTypeDialog, ChartEditRulesSegmentsDialog, ChartEditRulesHooksDialog, ChartEditColorDialog, MarkersEditDialog, DialogStatemonitorEditJSON ]
})
